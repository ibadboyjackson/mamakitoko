                                                ...
                                                <table class="center" align="right" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td class="btn" valign="top" style="line-height:0; padding:3px 0 0;">
                                                            <a target="_blank" style="text-decoration:none;" href="https://www.facebook.com/Mama-Kitoko-1691586500969612/"><img src="{{ asset('images/ico-facebook.png') }}" border="0" style="font:12px/15px Arial, Helvetica, sans-serif; color:#797c82;" align="left" vspace="0" hspace="0" width="6" height="13" alt="fb" /></a>
                                                        </td>
                                                        <td width="20"></td>
                                                        <td class="btn" valign="top" style="line-height:0; padding:3px 0 0;">
                                                            <a target="_blank" style="text-decoration:none;" href="https://twitter.com/KitokoMama/media"><img src="{{ asset('images/ico-twitter.png') }}" border="0" style="font:12px/15px Arial, Helvetica, sans-serif; color:#797c82;" align="left" vspace="0" hspace="0" width="13" height="11" alt="tw" /></a>
                                                        </td>
                                                        <td width="20"></td>
                                                        <td class="btn" valign="top" style="line-height:0; padding:3px 0 0;">
                                                            <a href="https://www.youtube.com/channel/UCxPgNRwt2ZcudI8vJFKI4OQ" target="_blank" class="size3 " style="font:15px/25px Arial, Helvetica, sans-serif; color:#797c82;">
                                                                <i class="fa fa-youtube-play"></i>
                                                            </a>
                                                        </td>
                                                        <td width="20"></td>
                                                        <td class="btn" valign="top" style="line-height:0; padding:3px 0 0;">
                                                            <a href="https://www.instagram.com/mamakitoko/" target="_blank" class="size3 " style="font:15px/25px Arial, Helvetica, sans-serif; color:#797c82;">
